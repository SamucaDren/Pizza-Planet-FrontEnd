  ...
  return (
    <>
      <div className={styles.imageContainerHeroSection}>
        ...
        >
          <path d="M743 371.5C743 272.972 703.86 178.48 634.19 108.81C564.52 39.1401 470.028 7.43865e-06 371.5 0C272.972 -7.43865e-06 178.48 39.14 108.81 108.81C39.1401 178.48 1.48773e-05 272.972 0 371.5L371.5 371.5H743Z" />
        </svg>
      </div>
    </>
  );
